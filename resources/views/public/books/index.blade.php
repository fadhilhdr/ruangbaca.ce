            ...
            <form method="GET" action="{{ route('public.books.index') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    @if(request('filter') && request('filter') != 'all')
                        <div class="space-y-1">
                            <label for="filter_value" class="block text-sm font-medium text-gray-700">{{ ucfirst(request('filter')) }}</label>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex gap-6">
                        ...
                        <div class="w-32 h-44 relative rounded-lg overflow-hidden bg-gray-100">
                            ...
                            @else
                                <div class="absolute inset-0 flex flex-col items-center justify-center bg-gray-50">
                                    <div class="w-10 h-10 mb-2 flex items-center justify-center rounded-full bg-gray-200">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4">
                                <a 
                                    href="{{ route('public.books.show', $book->isbn) }}"
            ...
            @empty
                ...
                <div class="text-center py-12 bg-white rounded-xl shadow-sm">
                    <svg class="mx-auto h-16 w-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M12 12h.01M12 14h.01M12 16h.01M12 18h.01M12 20h.01M12 22h.01" />
                    </svg>
