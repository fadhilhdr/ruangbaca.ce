                        ...
                        <div class="flex-1">
                            <dl class="space-y-4">
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ Str::title($bookReference->judul) }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">{{ Str::title('Penulis') }}</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ Str::title($bookReference->penulis) }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">ISBN</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $bookReference->isbn }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">{{ Str::title('Penerbit') }}</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ Str::title($bookReference->penerbit) }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                ...
                <div class="md:w-1/2 p-8 bg-white">
                    ...
                    <div class="mb-8 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        ...
                        <ul class="space-y-2 text-sm text-blue-800">
                            ...
                            <li class="flex items-start">
                                ...
                                Durasi peminjaman 2 minggu (dapat diperpanjang 1x)
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-blue-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    ...
                    <form id="borrowForm" action="{{ route('member.loans.borrow', $bookReference->isbn) }}" method="POST" class="space-y-6">
                        ...
                        <button type="submit" 
                            ...
                            {{ Str::title('Konfirmasi Peminjaman') }}
                        </button>
                    </form>
                </div>
            </div>
