...
{
    // Menampilkan daftar buku untuk halaman admin
    public function adminIndex()
    {
        $books = Book::with('specialization')->paginate(10); // Eager loading relasi specialization
        return view('admin.booksData.index', compact('books'));
    }
