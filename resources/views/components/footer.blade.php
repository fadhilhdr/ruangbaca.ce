    ...
    <div class="container mx-auto px-4 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
                <h4 class="text-lg font-semibold mb-4 pb-2 border-b border-gray-700">Kontak</h4>
                <address class="not-italic text-gray-300 space-y-3">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p>Kantor Tata Usaha Gd. Dekanat Lama</p>
                            <p>Gd. Laboratorium Komputer Teknik Komputer</p>
                            <p>Jl. Prof. Soedarto, S.H., Tembalang, Semarang 50275</p>
                        </div>
                    </div>
    ...
    <div class="border-t border-gray-700">
        <div class="container mx-auto px-4 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <a href="{{ route('credit') }}"">
                    <p class="text-gray-400 text-sm">Developed with ❤️ by Team S1T24K06</p>
                </a>
            </div>
        </div>
    </div>
