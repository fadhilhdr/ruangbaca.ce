            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group">
                    <a href="{{ route('public.books.index') }}" class="block">
                        <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-md hover:bg-blue-600 transition-all duration-300">
                            <div class="aspect-[4/3] relative">
                                ...
                                <div class="absolute inset-0 p-6 text-gray-700 group-hover:text-white flex flex-col justify-between">
                            ...
                            <div class="p-6 group-hover:text-white">
                                <h3 class="text-xl font-bold text-gray-900 group-hover:text-white mb-2">Koleksi Buku</h3>
                                <p class="text-gray-600 group-hover:text-white/90">Akses berbagai koleksi buku akademik untuk mendukung pembelajaran Anda</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('public.tugasakhirs.index') }}" class="block">
                        <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-md hover:bg-blue-600 transition-all duration-300">
                            ...
                            <div class="p-6 group-hover:text-white">
                                ...
                                <p class="text-gray-600 group-hover:text-white/90">Akses kumpulan tugas akhir mahasiswa sebagai referensi penelitian</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('public.capstones.index') }}" class="block">
                        <div class="bg-gray-50 rounded-2xl overflow-hidden shadow-md hover:bg-blue-600 transition-all duration-300">
                            ...
                            <div class="p-6 group-hover:text-white">
                                ...
                                <p class="text-gray-600 group-hover:text-white/90">Jelajahi proyek capstone mahasiswa untuk inspirasi</p>
                            </div>
                        </div>
                    </a>
                </div>
